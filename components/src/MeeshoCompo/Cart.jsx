...
const Cart = () => {
 ...
 // ... (existing imports and other code remain the same)
    ...
    <div>
      <div id="cart">
        {userCart.length > 0 ? (
          <>
            {userCart.map((pro) => (
              <div id="left" key={pro.id}> {/* Add a unique key prop */}
                <div>
          ...
          <div>
            <h3 style={{ color: "#f73c4f", textAlign: "center" }}>
              {" "}
              <br /> No products in the cart
            </h3>
            <img
              src="https://cdn.dribbble.com/users/324185/screenshots/15805709/after-login-no-product-on-cart-2_10.14.19_pm_1x.jpg"
              alt=""
            />
          </div>
        )}
